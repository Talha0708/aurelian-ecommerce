        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col justify-center lg:sticky lg:top-28">
              ...
              {/* 🎯 Updated Contentful Rich Text Description (CRASH FIX) */}
              <div className="mb-8">
                {product?.description ? (
                  typeof product.description === 'string' ? (
                    // 🎯 যদি প্রোডাক্টের ডেসক্রিপশন পুরনো প্লেইন টেক্সট হয়
                    <p className="text-gray-400 font-light leading-relaxed mb-5 text-lg whitespace-pre-wrap">
                      {product.description}
                    </p>
                  ) : (
                    // 🎯 যদি নতুন প্রোডাক্টের ডেসক্রিপশন Rich Text (Object) হয়
